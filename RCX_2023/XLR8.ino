...
void followLine(){
  ...
  if(position>40 && position<60){
    if(speedBaseReal<speedBoost){
      speedBaseReal = speedBaseReal+0.5;      
    }
    ...
    if(TempoDaSalvacao!=10000 && contMilli[1]-contMilli[0]>=TempoDaSalvacao && speedBaseReal<70){
      speedBaseReal = speedBaseReal + 5;
    }
